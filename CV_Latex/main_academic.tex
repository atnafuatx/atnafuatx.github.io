...
%\myname{Butt}{\bibnamedelima Sabur}
\myname{Tonja}{Atnafu Lambebo}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Atnafu Lambebo Tonja}

  \makefield{\faEnvelope[regular]}{\texttt{atnafu.lambebo@wsu.edu.et}}
  
  \makefield{\faEnvelope[regular]}{\texttt{atnafuatx@gmail.com}}
  
 \makefield{\faLinkedin}{\url{https://www.linkedin.com/in/atnafu-lambebo-6b21a5184/}}
 
  \makefield{{\faGithub}}{\url{https://github.com/atnafuatx}}
 
  \makefield{\faTwitter}{\url{https://twitter.com/AtnafuLambebo}}
